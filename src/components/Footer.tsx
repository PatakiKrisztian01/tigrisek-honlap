        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="text-gray-400 text-sm leading-relaxed space-y-2">
              ...
              {/* ITT VAN VISSZA A GOMBKÉNT FUNKCIONÁLÓ LINK */}
              <Link 
                to="/edzesek#kapcsolat" 
                className="block text-neon-orange font-bold tracking-wide pt-1 hover:text-white transition-colors cursor-pointer"
              >
