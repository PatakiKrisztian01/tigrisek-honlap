          ...
          <div className="bg-gray-900 border border-emerald-600/30 rounded-2xl overflow-hidden">
            <div className="flex flex-col lg:flex-row h-full">
              ...
              <div className="w-full lg:w-64 flex-shrink-0 bg-emerald-600/10 lg:border-l border-emerald-600/30">
                <img src="/555717957_25013974758240728_3275706361721851860_n.jpg" alt="Önvédelmi edzés" className="w-full h-64 lg:h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gray-900 border border-amber-600/30 rounded-2xl overflow-hidden">
            <div className="flex flex-col lg:flex-row h-full">
              ...
              <div className="w-full lg:w-64 flex-shrink-0 bg-amber-600/10 lg:border-l border-amber-600/30">
                <img src="/645785912_26451474827824040_4934349288100951462_n.jpg" alt="Ovis edzés" className="w-full h-64 lg:h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {videoThumbnails.map((src, i) => (
              <div key={i} className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden hover:border-neon-orange/50 transition-all duration-300 group cursor-pointer">
                <div className="relative">
                  <img src={src} alt={`Videó ${i + 1}`} className="w-full h-36 object-cover group-hover:scale-110 transition-transform duration-300" />
