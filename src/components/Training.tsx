  ...
  return (
    <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="group flex items-start gap-3 p-4 rounded-xl bg-gray-800/50 border border-gray-700 hover:border-neon-orange hover:scale-[1.03] hover:shadow-lg hover:shadow-neon-orange/30 transition-all duration-200 cursor-pointer">
      ...
      <div className="flex-1 min-w-0">
        {name && <p className="text-gray-300 text-sm md:text-base font-bold">{name}</p>}
        <p className="text-gray-400 text-sm md:text-base">{address}</p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
              <div className="bg-neon-orange px-6 py-3">
                <h3 className="text-black font-black text-lg md:text-xl">Hétfő</h3>
              </div>
              <div className="flex flex-col lg:flex-row h-full">
                <div className="flex-1 p-6 space-y-4">
                  <div className="flex items-start gap-3">
                    <Clock className="w-4 h-4 text-neon-orange flex-shrink-0 mt-1" />
                    <div>
                      <div className="text-white font-bold text-sm md:text-base">18:00 – 19:30</div>
                      <div className="text-gray-400 text-sm md:text-base mt-0.5">Küzdelem kicsiknek-nagyoknak</div>
                      <div className="text-neon-orange text-xs md:text-sm font-black mt-2">fehér öv – fekete öv</div>
                    </div>
                  </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
              <div className="flex flex-col lg:flex-row h-full">
                <div className="flex-1 p-6">
                  <h3 className="text-gray-300 text-sm md:text-base font-bold mb-1">TigersGym</h3>
                  <p className="text-gray-400 text-xs md:text-sm mb-4">A bázis technikai edzések, csoportokra osztva:</p>
                  <div className="mb-6">
                  ...
                  <div className="space-y-6">
                    <div>
                      <div className="bg-neon-orange/10 border border-neon-orange/30 px-4 py-2 rounded-lg mb-3 inline-block">
                        <h4 className="text-neon-orange font-bold text-sm md:text-base">Szerda</h4>
                      </div>
                      <div className="space-y-3 ml-2">
                        <div className="flex items-start gap-3">
                          <Clock className="w-4 h-4 text-neon-orange flex-shrink-0 mt-1" />
                          <div>
                            <div className="text-white font-bold text-sm md:text-base">16:30 – 18:00</div>
                            <div className="text-gray-400 text-sm md:text-base">Fehér öv sárga csík – zöld övig</div>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <Clock className="w-4 h-4 text-neon-orange flex-shrink-0 mt-1" />
                          <div>
                            <div className="text-white font-bold text-sm md:text-base">18:00 – 19:30</div>
                            <div className="text-gray-400 text-sm md:text-base">Zöld öv kék csík – piros övig</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-3 border-t border-gray-800/60">
                      <div className="bg-neon-orange/10 border border-neon-orange/30 px-4 py-2 rounded-lg mb-3 inline-block">
                        <h4 className="text-neon-orange font-bold text-sm md:text-base">Péntek</h4>
                      </div>
                      <div className="space-y-3 ml-2">
                        <div className="flex items-start gap-3">
                          <Clock className="w-4 h-4 text-neon-orange flex-shrink-0 mt-1" />
                          <div>
                            <div className="text-white font-bold text-sm md:text-base">16:30 – 18:00</div>
                            <div className="text-gray-400 text-sm md:text-base">Kezdő csoport</div>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <Clock className="w-4 h-4 text-neon-orange flex-shrink-0 mt-1" />
                          <div>
                            <div className="text-white font-bold text-sm md:text-base">18:00 – 19:30</div>
                            <div className="text-gray-400 text-sm md:text-base">Piros övtől 3.dan-ig</div>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex flex-col lg:flex-row h-full">
              <div className="flex-1 p-6 lg:p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-black text-white">Ingyenes önvédelmi edzések</h2>
                    <p className="text-emerald-400 font-bold text-sm md:text-base">14 éves kortól</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 mb-4">
                  <Clock className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-1" />
                  <div className="text-white font-bold text-sm md:text-base">Kedd: 18:00 – 19:00-ig</div>
                </div>
              ...
              <div className="w-full lg:w-64 flex-shrink-0 bg-emerald-600/10 lg:border-l border-emerald-600/30">
                <img src="/onvedelem.webp" alt="Önvédelmi edzés" className="w-full h-64 lg:h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row h-full">
              <div className="flex-1 p-6 lg:p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-black text-white">Ovis edzések</h2>
                    <p className="text-amber-400 font-bold text-sm md:text-base">4 éves kortól</p>
                  </div>
                </div>
                <div className="space-y-3 mb-6">
                  <div className="flex items-start gap-3">
                    <Clock className="w-4 h-4 text-amber-400 flex-shrink-0 mt-1" />
                    <div className="text-white font-bold text-sm md:text-base">Kedd: 16:30 – 17:30-ig</div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Clock className="w-4 h-4 text-amber-400 flex-shrink-0 mt-1" />
                    <div className="text-white font-bold text-sm md:text-base">Csütörtök: 16:30 – 17:30-ig</div>
                  </div>
                </div>
              ...
              <div className="w-full lg:w-64 flex-shrink-0 bg-amber-600/10 lg:border-l border-amber-600/30">
                <img src="/ovis.webp" alt="Ovis edzés" className="w-full h-64 lg:h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
